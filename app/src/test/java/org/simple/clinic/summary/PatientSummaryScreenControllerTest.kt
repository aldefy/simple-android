...
class PatientSummaryScreenControllerTest {
  ...
  private fun `patient summary callers`() = listOf(
      ...
      PatientSummaryCaller.LinkIdWithPatient(AddIdToPatient.AddBpPassportToPatient(UUID.randomUUID(), "1234567"))
  )
  ...
  private fun `patient summary callers and summary item changed`(): List<List<Any>> {
    val addIdToPatient = AddIdToPatient.AddBpPassportToPatient(bpPassportCode = UUID.randomUUID(), bpPassportShortCode = "1234567")
